...
export class ChangesetGenerationConfig {
  public static setupConfig() {
    Config.App.merge({
      ...
      // -----------------------------------------------------------------------------------------------------------
      imjs_agent_client_id: process.env.iModeljsAgentId!,
      imjs_agent_client_secret: process.env.iModeljsAgentSecret!,
      ...
      // -----------------------------------------------------------------------------------------------------------
      imjs_agent_project_name: "Test2",
      imjs_agent_imodel_name: "Test2",
